...
if TYPE_CHECKING:
    ...
    # magcache env vars
    SGLANG_MAGCACHE_ENABLED: bool = False
    SGLANG_MAGCACHE_CALIBRATION_MODE: bool = False
    SGLANG_MAGCACHE_RATIO_FILE: str | None = None
    SGLANG_MAGCACHE_SKIP_THRESHOLD: float = 0.1
    # model loading
